...
Page({
    ...
    data: {
        ...
        qaOpinion: '',
        qaOpinionMemo: '',
        colorSmellList:[{id:"1",name:"name1"},{id:"2",name:"name2"}],
        gradeList:[{id:"1",name:"level1"},{id:"2",name:"level2"}],
        qaOpinionList:[{id:"1",name:"意见1"},{id:"2",name:"意见2"}]
    },
    ...
    save: function(){
        ...
        call.request('/api/wms/wmsInPlan/save',this.data.plan,(data)=>{
            console.log('登记完成！')
            wx.showToast({
              title: '入库登记完成',
            })
